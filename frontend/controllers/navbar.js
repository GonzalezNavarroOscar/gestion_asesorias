                ...
                <div class="options">
                    <li id="message">
                        ...
                        <div class="messages_popup" style="display: none;">
                            ...
                            <button onclick="window.location.href='../pages/chat.html'">Ver mensajes</button>
                        </div>
                    </li>
                    <li id="bell">
                        <button class="icon-btn" id="bell-btn">
                            <img src="../images/Campana.png" class="notifications default-icon">
                            <img src="../images/Campana_Notificacion.png" class="notifications notification-icon" style="display: none;">
                        </button>
